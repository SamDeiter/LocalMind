...
export function renderConversations() {
  ...
  state.conversations.forEach((c) => {
    ...
    div.className = `conversation-item flex items-center justify-between px-3 py-2 text-sm rounded-r-lg cursor-pointer transition-all group focus-within:bg-[#1c1b1b] ${
    ...
    div.addEventListener("keydown", (e) => {
      // Only load conversation if the event was triggered on the item itself,
      // not on its child buttons (export/delete).
