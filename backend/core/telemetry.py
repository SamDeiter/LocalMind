...
class MetricsCollector:
    ...
    def get_metrics_summary(
        ...
        # This is significantly faster than fetching all rows and parsing in Python.
        query = f"""
            SELECT
                -- LLM Calls
        ...
        # SQLite returns NULL for SUM() if no rows match, default to 0
...
class AlertManager:
    ...
    def check_thresholds(self, since: Optional[str] = None) -> list[dict[str, Any]]:
        ...
        try:
            ...
            # ⚡ Bolt: Use SQL aggregation and window functions to calculate stats in-DB
            ...
            query = f"""
                ...
                SELECT
                    ...
                    (SELECT duration_ms FROM ranked_latencies
                     WHERE rank = CAST(total_count * 0.95 AS INT) + 1 LIMIT 1) as p95_latency
                FROM job_stats
            """
