...
class MetricsCollector:
    ...
    def get_metrics_summary(
        ...
        # This avoids loading thousands of JSON blobs into Python, reducing
        # latency by ~3-4x for large metric sets.
        where = ""
        params = []
        if since:
...
class AlertManager:
    ...
    def check_thresholds(self, since: Optional[str] = None) -> list[dict[str, Any]]:
        ...
        try:
            ...
            # ⚡ Bolt: Only fetch specific fields via json_extract to minimize
            # data transfer from DB while allowing Python-side P95 calculation.
