...
class MetricsCollector:
    ...
    def get_metrics_summary(
        ...
        """
        # ⚡ Bolt: Optimized using a single SQLite aggregation query with FILTER and json_extract.
        # This shifts the JSON deserialization and aggregation overhead into SQLite's optimized C implementation,
        # avoiding pulling thousands of rows across the process boundary and parsing/iterating over JSON in Python.
        conn = _connect()
        try:
            sql = """
                SELECT
