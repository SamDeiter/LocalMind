...
def safe_resolve(base_dir: Path | str, user_path: str | Path) -> Path:
    ...
    # --- Enforce jail via is_relative_to check -----------------------------
    # Ensures the candidate is strictly a child of or equal to the jail root.
    # respects path boundaries and directory separators.
